...
public class TestDrivers {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            employee[0] = new Staff("Andrii", "Allen", "123", 'M', sdf.parse("2/23/59"), 50.00); /*
                                                                                                 * creating a new Staff
                                                                                                 * object
                                                                                                 */

            employee[1] = new Staff("Linda", "Zapata", "456", 'F', sdf.parse("7/12/64"), 35.00);

            employee[2] = new Staff("Erick", "Rios", "789", 'M', sdf.parse("6/2/70"), 40.00);

            employee[3] = new Faculty("Anna", "Johnson", "243", 'F', sdf.parse("4/27/62"), Level.FU,
                    new Education("Ph.D", "Engineering", 3));/*
                                                              * creating a new Faculty object; and an Edcuation object
                                                              * is passed as one of the arguments
                                                              */

            employee[4] = new Faculty("William", "Bouris", "791", 'F', sdf.parse("3/14/75"), Level.AO,
                    new Education("Ph.D", "English", 1));

            employee[5] = new Faculty("Christopher", "Andrade", "623", 'F', sdf.parse("5/22/80"), Level.AS,
                    new Education("MS", "Physical Education", 0));

            employee[6] = new Parttime("James", "Guzman", "455", 'F', sdf.parse("8/10/77"), 35.00, 30);

            employee[7] = new Parttime("Marta", "Depirro", "678", 'F', sdf.parse("9/15/87"), 30.00, 15);

            employee[8] = new Parttime("Marquez", "Aldaco", "945", 'M', sdf.parse("11/24/88"), 20.00, 35);
